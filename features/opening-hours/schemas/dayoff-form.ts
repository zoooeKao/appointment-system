...
import { parseTimeString, formatTimeString, addMinutesToTime, minusMinutesToTime, updateDayOffSchedule } from '@/features/opening-hours/utils/date-time-format';
import { DEFAULT_DAY_SCHEDULE } from '@/features/opening-hours/services';

const dayOffFormFields = (excludeDates: string[] = []): FormFieldType[] => [
  {
    name: 'dayOffDate',
    label: '日期',
    type: 'date',
...
export default dayOffFormFields;