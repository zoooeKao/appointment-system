...
import BaseAlertDialog from '@/components/base-alert-dialog/BaseAlertDialog';
...
import { ServiceCategoryManagementView } from './views/ServiceCategoryManagementView';
