...
import { WEEK_LABELS } from '@/features/opening-hours/consts';
import DatePicker from 'react-datepicker';
import 'react-datepicker/dist/react-datepicker.css';
import BaseDatePicker from '@/components/base-date-picker/BaseDatePicker';
import type { TimeSlotType, TimeType, WeeklySchedule } from '@/components/base-date-picker/type';
                            ...
                            {scheme.type === 'date' && (
                              <div className="flex flex-col">
                                <DatePicker
                                  ...
                                  disabled={isUploading}
                                  excludeDates={scheme.excludeDates?.map(date => new Date(date))}
                                />
                              </div>
                            )}
